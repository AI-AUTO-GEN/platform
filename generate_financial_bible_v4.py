...
def parse_formula(desc):
    ...
    if "megapixel" in desc_l:
    ...
    elif "second of video" in desc_l or "second of " in desc_l or "/sec" in desc_l:
    ...
    elif "per image" in desc_l or "per generation" in desc_l or "times" in desc_l or "per request" in desc_l:
        variables.append("Petición Determinista (Generación Simple)")
        formula = "Coste = Coste_Fijo_Base"
        ...
        variables.append("Petición Determinista (Generación Fija)")
        formula = "Coste = Precio Estándar por Inferencia"
...
if __name__ == "__main__":
    generate()
    print("V4 Generated with 1312 Models!")
